-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc2\untitled\Sobel_Y.vhd
...
-- 
-- Module: Sobel_Y
-- Source Path: untitled/Subsystem3/Sobel Y
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Sobel_Y IS
  ...
  SIGNAL Gain1_cast                       : unsigned(15 DOWNTO 0);  -- ufix16_En6
  ...
  SIGNAL Gain7_cast                       : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Gain7_mul_temp                   : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL Gain24_cast                      : signed(8 DOWNTO 0);  -- sfix9
...
BEGIN
  ...
  Gain_out1 <= signed(resize(Input_unsigned, 16));
  ...
  Gain1_out1 <= signed(resize(Gain1_cast(15 DOWNTO 6), 16));
  ...
  Gain3_out1 <= to_signed(16#0000#, 16);
  ...
  Gain5_out1 <= to_signed(16#0000#, 16);
  ...
  Gain7_cast <= signed(resize(Delay6_out1, 9));
  -- CSD Encoding (2) : 10; Cost (Adders) = 0
  Gain7_mul_temp <=  - (resize(Gain7_cast & '0', 25));
  Gain7_out1 <= Gain7_mul_temp(15 DOWNTO 0);
  ...
  Gain24_cast <= signed(resize(Delay7_out1, 9));
  Gain24_out1 <= resize( - (Gain24_cast), 16);
  ...
  Gy <= std_logic_vector(Add13_out1);
